...
const Header = ({
  ...
  const bannerMsg = "Blitz sekarang memasuki versi beta! 🎉 1.0 diharapkan bulan April tahun ini"
  ...
  const menuLinks = [
    ...
    {name: "Rilis", href: "https://github.com/blitz-js/blitz/releases"},
    {name: "Wiki", href: "https://github.com/blitz-js/blitz/wiki"},
    {name: "Merchandise", href: "https://store.blitzjs.com"},
  ]
      ...
      <nav className={`${stickyBgClass ? "sticky top-0 z-50" : ""}`}>
        <div className={`flex items-center justify-between lg:mt-4 ${className} ${stickyBgClass}`}>
          <div className="pr-8 xl:pr-12 lg:-mt-3">
            <Link href="/">
              <a className="w-10 overflow-hidden md:w-auto">
                <span className="sr-only">Helaman beranda Blitz</span>
                {useColoredLogo && (
          ...
          <div className="flex-1 hidden space-x-4 xl:space-x-6 text-base lg:flex">
            ...
            >
              <FaHeart className="inline mr-1 align-text-top" /> Donasi/Sponsor
        ...
        {isOpen && (
          ...
          >
            ...
            <NavLink
              ...
              href="https://github.com/sponsors/blitz-js"
            >
              <FaHeart size="1rem" className="inline mr-1 mb-1 align-text-center" /> Donasi/Sponsor
              <HiExternalLink size="1rem" className="opacity-70 absolute top-3 right-0" />
            </NavLink>
            <div className="py-2">
